...
const Playgrounds = [
  { name: 'Detection', description: 'Paragraph', href: '#', icon: ChartPieIcon },
  { name: 'Predictive', description: 'Paragraph', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Chatbot', description: 'Paragraph', href: '#', icon: FingerPrintIcon },
]
      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">NEXGENAI</span>
            <img
              alt=""
